...
public class ApiServlet extends HttpServlet {
	...
	private String generateAuthorizationHeader(String methed, String uri, Hashtable<String, String> params) {
		...
		try {
			...
			String header_str = "OAuth oauth_nonce=\"" + nonce + "\", oauth_signature_method=\"HMAC-SHA1\", oauth_timestamp=\"" + timestamp + "\", oauth_consumer_key=\"" + URLEncoder.encode(Configuration.getConsumerKey()) + "\", oauth_token=\"" + URLEncoder.encode(accessToken.getToken()) + "\", oauth_signature=\"" + URLEncoder.encode(signature) + "\", oauth_version=\"1.0\"";
