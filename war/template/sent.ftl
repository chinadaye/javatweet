...
<img alt="loader" src="/img/ajax-loader-big.gif"/>
	...
	<div id="statuses" class="statuses">
	    ...
	    <ul id="dm_tabs" class="tabMenu">
	      <li id="inbox_tab" ><a href="/inbox" class="in-page-link" ><span>收件箱</span></a></li>
	      <li id="sent_tab" class="active"><a href="/sent" class="in-page-link" ><span>发件箱</span></a></li>
	    </ul>
      </div>
		<div class="fixed"></div>
		<div id="msg_warp">
			<#include "message_element_sent.ftl" /> 
		</div>
		<div class="fixed"></div>
		<div id="msg_page">
