            	...
            	<div class="wrapper">
                	<form action="/home" class="status-update-form" id="status_update_form" method="post">
                      ...
                      <div class="bar">
							...
							<span class="numeric right">剩余：<strong id="status-field-char-counter" class="char-counter green">140</strong>字</span>
						</div>
                      <textarea id="status" name="status" ></textarea>
                      <br />
                        <span id="ajax_msg_status" class="ajax_msg left"></span>
                        <input type="submit" name="update" value="我推！" id="update-submit" class="status-btn round right" />
                        <input type="reset" name="reset" value="清除" id="update-reset" class="status-btn round right" />
                    </form>
                    <div class="fixed"></div>
                    ...
                    <a href="javascript:getmoresearch('${s}');" class="round more" id="more" rel="next"><div id="pagination"><h3>more</h3></div></a>
                <!--#wrapper--></div>
			<!--#content--></td>
