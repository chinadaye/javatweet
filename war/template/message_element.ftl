...
<#list msg as m>
	...
	<div class="user_img_div"><img src="http://img.tweetimag.es/i/${m.senderScreenName}_n" class="user_img" alt="${m.senderScreenName}"/></div>
	<div class="msg_content">
		<span class="msg_user"><a href="/@${m.senderScreenName}">${m.senderScreenName}</a></span>
